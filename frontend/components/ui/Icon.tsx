...
export default function Icon({ name, size = 16 }: IconProps) {
  ...
  const icons: Record<string, JSX.Element> = {
    ...
    search:    <svg {...props}><circle cx="11" cy="11" r="7"/><line x1="16.5" y1="16.5" x2="21" y2="21"/></svg>,
    ...
    receipt:   <svg {...props}><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>,
    coin:      <svg {...props}><circle cx="12" cy="12" r="9"/><path d="M8 12h8"/><path d="M12 8v8"/></svg>,
    plus:      <svg {...props} strokeWidth={2}><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>,
    ...
    arrow_up:  <svg {...props} strokeWidth={2}><line x1="12" y1="19" x2="12" y2="5"/><polyline points="5 12 12 5 19 12"/></svg>,
    arrow_left:<svg {...props}><line x1="19" y1="12" x2="5" y2="12"/><polyline points="12 19 5 12 12 5"/></svg>,
    ...
    copy:      <svg {...props}><rect x="9" y="9" width="13" height="13" rx="2" ry="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>,
    solana:    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor"><path d="M4 17h13l3-3H7L4 17zm0-7h13l3-3H7L4 10zm16 3.5L17 10H4l3 3.5h13z" opacity=".85"/></svg>,
  };
